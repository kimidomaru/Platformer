...
var I18N = (function () {
  ...
  var _strings = {
    pt: {
      ...
      welcomeTitle: 'Bem-vindo ao Platformer',
      welcomeSub: 'Sua plataforma local de estudo para certificacoes Cloud Native e Cloud. Comece escolhendo um caminho abaixo — seu progresso fica salvo neste navegador.',
      qsTrailsTitle: 'Trilhas por cargo',
      qsTrailsDesc: 'Sequencias guiadas (DevOps, SRE, Platform, Cloud) do basico ao avancado.',
      qsMapTitle: 'Mapa de topicos',
      qsMapDesc: 'Explore todos os topicos e suas conexoes de forma visual.',
      qsExamTitle: 'Simulado',
      qsExamDesc: 'Teste seu nivel com questoes no estilo da prova e cronometro.',
    ...
    en: {
      ...
      welcomeTitle: 'Welcome to Platformer',
      welcomeSub: 'Your local-first study platform for Cloud Native and Cloud certifications. Start by picking a path below — your progress is saved in this browser.',
      qsTrailsTitle: 'Role-based trails',
      qsTrailsDesc: 'Guided sequences (DevOps, SRE, Platform, Cloud) from basics to advanced.',
      qsMapTitle: 'Topic map',
      qsMapDesc: 'Explore every topic and how they connect, visually.',
      qsExamTitle: 'Mock exam',
      qsExamDesc: 'Test your level with exam-style questions and a timer.',
